...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'aishiftscheduler.config': {},
            'aishiftscheduler.dbmodels': { 'aishiftscheduler.dbmodels.UserInput': ( 'dbmodels.html#userinput',
            ...
            'aishiftscheduler.policy': { 'aishiftscheduler.policy.Policy': ('policy.html#policy', 'aishiftscheduler/policy.py'),
                                         ...
                                         'aishiftscheduler.policy.parallel_run_grid_sample_paths': ( 'policy.html#parallel_run_grid_sample_paths',
                                                                                                     'aishiftscheduler/policy.py')},
            'aishiftscheduler.production': { 'aishiftscheduler.production.create_userinputs': ( 'production.html#create_userinputs',
                                                                                                'aishiftscheduler/production.py'),
                                             'aishiftscheduler.production.delete_userinput': ( 'production.html#delete_userinput',
                                                                                               'aishiftscheduler/production.py'),
                                             'aishiftscheduler.production.find_index_userinput': ( 'production.html#find_index_userinput',
                                                                                                   'aishiftscheduler/production.py'),
                                             'aishiftscheduler.production.find_schedule': ( 'production.html#find_schedule',
                                                                                            'aishiftscheduler/production.py'),
                                             'aishiftscheduler.production.find_userinput': ( 'production.html#find_userinput',
                                                                                             'aishiftscheduler/production.py'),
                                             'aishiftscheduler.production.get_db': ( 'production.html#get_db',
                                                                                     'aishiftscheduler/production.py'),
                                             'aishiftscheduler.production.get_default_user_input': ( 'production.html#get_default_user_input',
                                                                                                     'aishiftscheduler/production.py'),
                                             'aishiftscheduler.production.get_userinput': ( 'production.html#get_userinput',
                                                                                            'aishiftscheduler/production.py'),
                                             'aishiftscheduler.production.get_userinputs': ( 'production.html#get_userinputs',
                                                                                             'aishiftscheduler/production.py'),
                                             ...
                                             'aishiftscheduler.production.update_parameters_from_user_input': ( 'production.html#update_parameters_from_user_input',
                                                                                                                'aishiftscheduler/production.py'),
                                             'aishiftscheduler.production.update_userinput': ( 'production.html#update_userinput',
                                                                                               'aishiftscheduler/production.py')},
            'aishiftscheduler.schemas': { 'aishiftscheduler.schemas.UserInput': ('schemas.html#userinput', 'aishiftscheduler/schemas.py'),
