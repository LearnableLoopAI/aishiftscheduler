...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'aishiftscheduler.config': {},
            'aishiftscheduler.database': {'aishiftscheduler.database.get_db': ('database.html#get_db', 'aishiftscheduler/database.py')},
            'aishiftscheduler.dbmodels': { 'aishiftscheduler.dbmodels.User': ('dbmodels.html#user', 'aishiftscheduler/dbmodels.py'),
                                           'aishiftscheduler.dbmodels.UserInput': ( 'dbmodels.html#userinput',
                                                                                    'aishiftscheduler/dbmodels.py')},
            'aishiftscheduler.envconfig': { 'aishiftscheduler.envconfig.Settings': ( 'envconfig.html#settings',
                                                                                     'aishiftscheduler/envconfig.py'),
                                            'aishiftscheduler.envconfig.Settings.Config': ( 'envconfig.html#settings.config',
                                                                                            'aishiftscheduler/envconfig.py')},
            ...
            'aishiftscheduler.model': { 'aishiftscheduler.model.Model': ('model.html#model', 'aishiftscheduler/model.py'),
                                        ...
                                        'aishiftscheduler.model.Model.update_Ccum': ( 'model.html#model.update_ccum',
                                                                                      'aishiftscheduler/model.py')},
            'aishiftscheduler.oauth2': { 'aishiftscheduler.oauth2.create_access_token': ( 'oauth2.html#create_access_token',
                                                                                          'aishiftscheduler/oauth2.py'),
                                         'aishiftscheduler.oauth2.get_current_user': ( 'oauth2.html#get_current_user',
                                                                                       'aishiftscheduler/oauth2.py'),
                                         'aishiftscheduler.oauth2.verify_access_token': ( 'oauth2.html#verify_access_token',
                                                                                          'aishiftscheduler/oauth2.py')},
            ...
            'aishiftscheduler.policy': { 'aishiftscheduler.policy.Policy': ('policy.html#policy', 'aishiftscheduler/policy.py'),
                                         ...
                                         'aishiftscheduler.policy.parallel_run_grid_sample_paths': ( 'policy.html#parallel_run_grid_sample_paths',
                                                                                                     'aishiftscheduler/policy.py')},
            'aishiftscheduler.production': { 'aishiftscheduler.production.find_schedule': ( 'production.html#find_schedule',
                                             ...
                                             'aishiftscheduler.production.update_parameters_from_user_input': ( 'production.html#update_parameters_from_user_input',
                                                                                                                'aishiftscheduler/production.py')},
            'aishiftscheduler.routers': { 'aishiftscheduler.routers.create_user': ( 'routers.html#create_user',
                                                                                    'aishiftscheduler/routers.py'),
                                          'aishiftscheduler.routers.create_userinputs': ( 'routers.html#create_userinputs',
                                                                                          'aishiftscheduler/routers.py'),
                                          'aishiftscheduler.routers.delete_userinput': ( 'routers.html#delete_userinput',
                                                                                         'aishiftscheduler/routers.py'),
                                          'aishiftscheduler.routers.get_userinput': ( 'routers.html#get_userinput',
                                                                                      'aishiftscheduler/routers.py'),
                                          'aishiftscheduler.routers.get_userinputs': ( 'routers.html#get_userinputs',
                                                                                       'aishiftscheduler/routers.py'),
                                          'aishiftscheduler.routers.login': ('routers.html#login', 'aishiftscheduler/routers.py'),
                                          'aishiftscheduler.routers.update_userinput': ( 'routers.html#update_userinput',
                                                                                         'aishiftscheduler/routers.py')},
            'aishiftscheduler.schemas': { 'aishiftscheduler.schemas.Token': ('schemas.html#token', 'aishiftscheduler/schemas.py'),
                                          'aishiftscheduler.schemas.TokenData': ('schemas.html#tokendata', 'aishiftscheduler/schemas.py'),
                                          'aishiftscheduler.schemas.UserCreate': ('schemas.html#usercreate', 'aishiftscheduler/schemas.py'),
                                          'aishiftscheduler.schemas.UserInput': ('schemas.html#userinput', 'aishiftscheduler/schemas.py'),
                                          'aishiftscheduler.schemas.UserInput.Config': ( 'schemas.html#userinput.config',
                                                                                         'aishiftscheduler/schemas.py'),
                                          'aishiftscheduler.schemas.UserInputBase': ( 'schemas.html#userinputbase',
                                                                                      'aishiftscheduler/schemas.py'),
                                          'aishiftscheduler.schemas.UserInputCreate': ( 'schemas.html#userinputcreate',
                                                                                        'aishiftscheduler/schemas.py'),
                                          'aishiftscheduler.schemas.UserInputUpdate': ( 'schemas.html#userinputupdate',
                                                                                        'aishiftscheduler/schemas.py'),
                                          'aishiftscheduler.schemas.UserLogin': ('schemas.html#userlogin', 'aishiftscheduler/schemas.py'),
                                          'aishiftscheduler.schemas.UserOut': ('schemas.html#userout', 'aishiftscheduler/schemas.py'),
                                          'aishiftscheduler.schemas.UserOut.Config': ( 'schemas.html#userout.config',
                                                                                       'aishiftscheduler/schemas.py')},
            ...
            'aishiftscheduler.trainer': { 'aishiftscheduler.trainer.do_train': ('trainer.html#do_train', 'aishiftscheduler/trainer.py'),
                                          ...
                                          'aishiftscheduler.trainer.train_schedule': ( 'trainer.html#train_schedule',
                                                                                       'aishiftscheduler/trainer.py')},
            'aishiftscheduler.user': { 'aishiftscheduler.user.create_user': ('routers/user.html#create_user', 'aishiftscheduler/user.py'),
                                       'aishiftscheduler.user.get_user': ('routers/user.html#get_user', 'aishiftscheduler/user.py')},
            'aishiftscheduler.userinput': { 'aishiftscheduler.userinput.create_user': ( 'routers.html#create_user',
                                                                                        'aishiftscheduler/userinput.py'),
                                            'aishiftscheduler.userinput.create_userinputs': ( 'routers.html#create_userinputs',
                                                                                              'aishiftscheduler/userinput.py'),
                                            'aishiftscheduler.userinput.delete_userinput': ( 'routers.html#delete_userinput',
                                                                                             'aishiftscheduler/userinput.py'),
                                            'aishiftscheduler.userinput.get_userinput': ( 'routers.html#get_userinput',
                                                                                          'aishiftscheduler/userinput.py'),
                                            'aishiftscheduler.userinput.get_userinputs': ( 'routers.html#get_userinputs',
                                                                                           'aishiftscheduler/userinput.py'),
                                            'aishiftscheduler.userinput.update_userinput': ( 'routers.html#update_userinput',
                                                                                             'aishiftscheduler/userinput.py')},
            'aishiftscheduler.utils': { 'aishiftscheduler.utils.gap_minutes': ('utils.html#gap_minutes', 'aishiftscheduler/utils.py'),
                                        'aishiftscheduler.utils.hash': ('utils.html#hash', 'aishiftscheduler/utils.py'),
                                        ...
                                        'aishiftscheduler.utils.print_schedule_slots': ( 'utils.html#print_schedule_slots',
                                                                                         'aishiftscheduler/utils.py'),
                                        'aishiftscheduler.utils.verify': ('utils.html#verify', 'aishiftscheduler/utils.py')},
