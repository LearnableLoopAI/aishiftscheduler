...
# %% auto 0
__all__ = ['app', 'dui', 'Pars', 'prepare_schedule', 'update_parameters_from_user_input', 'UserInput', 'root', 'get_userinputs',
           'create_userinputs', 'get_default_user_input', 'find_schedule']
...
@app.get("/userinputs")
def get_userinputs():
    return {"data": "This is your userinputs"}

# %% ../nbs/10_production.ipynb 18
@app.post("/createuserinputs")
def create_userinputs(payLoad: dict = Body(...)):
    print(payLoad)
