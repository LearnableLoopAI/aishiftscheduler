...
# %% auto 0
__all__ = ['SQLALCHEMY_DATABASE_URL', 'engine', 'SessionLocal', 'Base', 'app', 'my_userinputs', 'dui', 'Pars', 'prepare_schedule',
           'update_parameters_from_user_input', 'get_db', 'find_userinput', 'find_index_userinput', 'root',
           'get_userinputs', 'create_userinputs', 'get_userinput', 'delete_userinput', 'update_userinput',
